...
namespace OrderAndisheh.Domain.Test.EntityTest
{
    ...
    public class TahvilFroshEntityTest
    {
        ...
        {
            TahvilFroshEntity tahvilFrosh = new TahvilFroshEntity(Ultility.getProductList_Default(), 15);
        ...
        {
            TahvilFroshEntity tahvilFrosh = new TahvilFroshEntity(Ultility.getProductList_Default(), 0);
        }
    }
}